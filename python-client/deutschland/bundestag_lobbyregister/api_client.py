...
from deutschland.bundestag_lobbyregister import rest
...
from deutschland.bundestag_lobbyregister.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.suche_detail_json  # this is an instance of the class Endpoint
        api_instance.suche_detail_json()  # this invokes api_instance.suche_detail_json.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.suche_detail_json.callable or self.callable in this class
